...
public class Addproduct extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Required_Investment=request.getParameter("Required_Investment");
		...
		try {
			...
			st.executeUpdate("insert into product_info(ProductName, CompanyName, DescriptionName, MFGDate,Price,ExpiryDate,Qty,Product_No,Farmer_Email_ID,Farmer_Mobile_No,Land_Area,Required_Investment) values ('"
							+ productName
							+ "','"
							+ companyname
							+ "','"
							+ Descriptionname
							+ "','" + mfgdate + "','"+price+"','"+Expirydate+"','"+qty+"','"+product_No+"','"+emailid+"','"+mobile+"','"+Land_Area+"','"+Required_Investment+"')");
