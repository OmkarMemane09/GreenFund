...
String Distribute_Mobile_No=(String)session.getAttribute("Cmobile");
		try {
			...
			if (rs.next()) {
				...
				String Farmer_Price=rs.getString("Price");
				String Farmer_Email_ID=rs.getString("Farmer_Email_ID");
				String Farmer_Mobile_No=rs.getString("Farmer_Mobile_No");
				st.executeUpdate("insert into product_info_order(Distribute_Email_ID, Product_No,ProductName,CompanyName,Order_Qty,MId,Distribute_Mobile_No,Status_Info,Product_Price,Farmer_Price,Farmer_Email_ID,Farmer_Mobile_No) values ('"
						+ Distribute_Email_ID
						+ "','"
						+ product_No
						+ "','"
						...
						+ "','0','0','"+Farmer_Price+"','"+Farmer_Email_ID+"','"+Farmer_Mobile_No+"')");
