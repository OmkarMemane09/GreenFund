		...
		<h3 align="center"><b>View Information:</b></h3>
		 <div >
		  <div  >
			...
			<td><b>Farmer_Email_ID</b></td>
			<td><b>Farmer_Mobile No</b></td>
			<td><b>ProductName:</b></td>
			<td><b>CompanyName</b></td>
			<td><b>Qty</b></td>
			<td><b>Farmer Price</b></td>
			...
			String Distribute_Email_ID=(String)session.getAttribute("Cuserid");
					  try{
						  int i=1;
						  String query="select * from product_info_order where Distribute_Email_ID='"+Distribute_Email_ID+"'";
